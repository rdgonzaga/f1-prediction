...
Run `python -m f1pred build` first so `data/processed` is up to date.
...
4. `03_next_race.ipynb`: predicted order and win/podium chances for a race after qualifying.
